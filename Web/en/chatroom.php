	...
	<div class="container-fluid" id="mainContainerDiv">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<div class="container" id="contentDiv">
			<div class="container">
				<div class="row justify-content-center" id="messagingSection">
					<div style="width:80%; margin-left:5%;">
						<h3>Messages</h3>
						<div class="container-fluid scroll" style="overflow-y: scroll; overflow-x: hidden; max-height:500px;" id="messagesdiv">

						</div>
						<div class="text-left" style="margin-top: 2%;">
							<p class="lead emoji-picker-container">
								<input type="text" class="form-control" style="display: inline" id="chatmessage" placeholder="Message:" name="message" data-emojiable="true"/>
							</p>
							<button class="btn btn-primary" id="sendButton" style="display: inline" type="submit" onclick="send()">Send</button>
						</div>
					</div>
				</div>
				<div style="margin-top: 0;" id="onlineList">
